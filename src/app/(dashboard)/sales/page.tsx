    ...
    <>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <ChartCard title={hasLabor ? 'Labor vs parts sales trend' : 'Parts sales trend'}>
            {trend.length ? (
              <TrendLineChart data={trend} series={hasLabor ? [{ key: 'Labor', label: 'Labor' }, { key: 'Parts', label: 'Parts' }] : [{ key: 'Parts', label: 'Parts' }]}
